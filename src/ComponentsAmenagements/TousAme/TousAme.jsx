...
N'oubliez pas de nous suivre également sur Whatsapp pour ne manquer aucune actualité sur les CDQ <a href="https://whatsapp.com/channel/0029Vap0vkYICVfkljiXNn0h/134"> cliquez ici pour plus d'informations</a>
#2eArrondissementpog #Assainissement #TravauxPublics #CDQ #PortGentil #CTRI
                    </p>
                </div>
...
Malheureusement, certaines constructions anarchiques entravent la bonne progression des travaux. La Mairie du 2e Arrondissement appelle donc à la coopération de tous pour garantir le bon déroulement de ces opérations vitales pour notre sécurité et notre environnement.
#2eArrondissementpog #Assainissement #TravauxPublics #PortGentil #CTRI                    </p>
                </div>
                <div className="TousAme-image">
            ...
            <div className="TousAme-card">
                <div className="TousAme-text">
                    <h4>[VISITE DE TERRAIN]</h4> {/* Ajout du nom du maire */}
                    <p>
...
Ils en ont profité pour rappeler que les gravats, remblais et autres matériaux ne sont pas à vendre, démentant ainsi les rumeurs qui circulent.
 #HenriClement #ProjetPise #Transparence #Éducation #BatisGabonSarl #PortGentil #2earrondissementpog #CTRI                   </p>
                </div>
                <div className="TousAme-image">
...
#VisiteDeTerrain #SécuritéÉlectrique #Mairie2eArrondissement #SEEG #PortGentil #CTRI                    </p>
                </div>
                <div className="TousAme-image">
